    ...
    <main>
        ...
        <div class="card" style="background: #fffbe6; border-left: 4px solid #f7b731; margin-bottom: 16px;">
            ...
            <div style="font-size:1.04em; color:#444;">
                <strong>Catatan:</strong> Silakan isi setiap parameter sesuai data produksi Anda.<br>
                Nilai pada kolom input <b>tidak diisi otomatis</b> — masukkan angka yang sesuai dengan kondisi nyata di
                perusahaan atau studi kasus Anda.<br><br>
                <span style="color:#b97b00;">Informasi:</span>
                <ul style="margin: 12px 0 0 18px; color:#555; font-size:0.98em;">
                    <li>Saat pertama kali membuka halaman, semua input di bawah ini belum merepresentasikan data apapun.
                    </li>
                    <li>Seluruh visualisasi dan hasil perhitungan akan otomatis menyesuaikan sesuai input yang Anda
                        masukkan dan tombol hitung yang Anda tekan.</li>
                    <li>Jika belum mengetahui nilai pastinya, gunakan data historis atau konsultasikan dengan pihak
                        terkait.</li>
                    <li>Semua nilai dapat diubah kapan saja sebelum proses perhitungan.</li>
                    <li>Pastikan <b>Rentang Variabel</b> (minimum & maksimum) sudah benar agar hasil perhitungan lebih
                        akurat.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="heatmap-legend" style="margin-top:10px; font-size:1em;">
                <strong>Keterangan:</strong>
                <ul style="margin: 6px 0 0 18px; color:#555;">
                    <li><b>X</b> = Persediaan</li>
                    <li><b>Y</b> = Permintaan</li>
                    <li><b>Z</b> = Produksi (hasil perhitungan fuzzy)</li>
                </ul>
            </div>
        </div>
