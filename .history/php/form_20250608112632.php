...
<body>
    ...
    <main>
        ...
        <!-- Visualisasi 3D Surface Plot (Fold/Unfold) -->
        <div class="card">
            <button id="toggle3dBtn" type="button" style="width:100%;background:#f7b731;color:#222;font-weight:600;padding:12px 0;border:none;border-radius:8px 8px 0 0;cursor:pointer;font-size:1.1rem;transition:background 0.2s;">
                Tampilkan Visualisasi 3D Surface & Contour (Khusus Pengguna Lanjutan)
            </button>
            <div id="surface3dSection" style="display:none;">
                ...
                <div style="margin-top:16px;font-size:0.98rem;color:#555;background:#fffbe6;border-left:4px solid #f7b731;padding:12px 18px;border-radius:8px;">
                    <b>Catatan:</b> Visualisasi 3D ini hanya untuk eksplorasi lanjutan dan biasanya digunakan oleh analis atau ahli. Jika Anda tidak memahami grafik 3D, tidak perlu khawatir—heatmap di atas sudah cukup mewakili hubungan antar variabel.
                </div>
            </div>
        </div>
        ...
        // Fold/Unfold 3D Section
        document.getElementById('toggle3dBtn').addEventListener('click', function() {
            const section = document.getElementById('surface3dSection');
            if (section.style.display === 'none') {
                section.style.display = 'block';
                this.textContent = 'Sembunyikan Visualisasi 3D Surface & Contour';
            } else {
                section.style.display = 'none';
                this.textContent = 'Tampilkan Visualisasi 3D Surface & Contour (Khusus Pengguna Lanjutan)';
            }
        });
        </script>
</body>
