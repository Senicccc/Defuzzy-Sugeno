...
<body>
    ...
    <main>
        ...
        <div class="card" style="background: #fffbe6; border-left: 4px solid #f7b731; margin-bottom: 16px;">
            ...
            <p style="font-size:1.04em; color:#444; margin-bottom:0;">
                ...
                <br>
                <span style="color:#b97b00;">Tips:</span> 
                <ul style="margin: 8px 0 0 18px; color:#555; font-size:0.98em;">
                    <li>Jika Anda belum tahu nilai pastinya, konsultasikan dengan data historis atau pihak terkait.</li>
