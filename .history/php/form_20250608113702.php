...
<body>
    ...
    <main>
                ...
                <div class="result-highlight">
                    ...
                    <div class="grid-cols-2">
                        <div>
                            ...
                            <small class="input-note">* Nilai produksi minimum, diambil dari nilai terendah antara hasil aturan R1 dan R2.</small>
                        </div>
                        <div>
                            <p><strong>Produksi Bertambah:</strong></p>
                            <p id="prodBertambah">0.0000</p>
                            <small class="input-note">* Nilai produksi maksimum, diambil dari nilai tertinggi antara hasil aturan R3 dan R4.</small>
                        </div>
                    </div>
        ...
        });arPermMin', 'varPermMax', 'varPersMin', 'varPersMax'].forEach(id => {
        </script>ent.getElementById(id).addEventListener('input', generateHeatmap);
</body> });
        </script>
</html>
