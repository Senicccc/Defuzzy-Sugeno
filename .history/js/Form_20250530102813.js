    ...
    options: {
      ...
      scales: {
        x: {
          type: "linear",
          min: 0, // mulai dari 0
          max: Math.round(varPermMax + (varPermMax - varPermMin) * 0.05), // atau pakai chartData.permintaan.labels.at(-1)
          title: {
            display: true,
    ...
    options: {
      ...
      scales: {
        x: {
          type: "linear",
          min: 0,
          max: Math.round(varPersMax + (varPersMax - varPersMin) * 0.05),
          title: {
            display: true,
