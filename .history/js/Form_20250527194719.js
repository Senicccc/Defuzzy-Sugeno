...
function updateCharts() {
    ...
    // Chart Permintaan
    permintaanChart = new Chart(document.getElementById("permintaanChart").getContext("2d"), {
        type: "line",
        data: {
            ...
            datasets: [
                ...
                // Garis vertikal merah putus-putus di titik input
                {
                    label: "Input",
                    data: [
                        {x: permintaanX, y: 0},
                ...
                // Garis horizontal merah dari sumbu Y ke titik input (Turun)
                {
                    label: "Turun Value",
                    data: [
                ...
                // Garis horizontal merah dari sumbu Y ke titik input (Naik)
                {
                    label: "Naik Value",
                    data: [
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    external: function(context) {
                        // Custom label di chart (pakai annotation lebih baik, tapi Chart.js v3+)
                    }
                },
                datalabels: {
                    display: true,
            ...
            scales: {
                x: {
                    title: { display: true, text: "Nilai Permintaan" },
                    type: "linear",
    ...
    // Chart Persediaan
    persediaanChart = new Chart(document.getElementById("persediaanChart").getContext("2d"), {
        type: "line",
        data: {
            ...
            datasets: [
                ...
                // Garis horizontal merah dari sumbu Y ke titik input (Sedikit)
                {
                    label: "Sedikit Value",
                    data: [
                ...
                // Garis horizontal merah dari sumbu Y ke titik input (Banyak)
                {
                    label: "Banyak Value",
                    data: [
        ...
        options: {
            ...
            scales: {
                x: {
                    title: { display: true, text: "Nilai Persediaan" },
                    type: "linear",
