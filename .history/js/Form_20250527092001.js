...
// Fungsi untuk menghitung derajat keanggotaan (diperbaiki)
...
// Fungsi untuk mempersiapkan data chart (diperbaiki)
...
// Fungsi untuk memperbarui chart (diperbaiki)
function updateCharts() {
        ...
        data: {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    borderWidth: 2,
                    borderDash: [5, 5],
                    pointRadius: 5, // Tambahkan titik di garis input
                    fill: false,
                    showLine: true,
                },
            ],
    ...
    // Buat chart persediaan (mirip dengan permintaan)
